                ...
                <div className="self-center w-full mt-6">
                    <div className="bg-white border rounded-lg shadow-xl">
                        <form className="py-3 px-6" onSubmit={handleRegister}>
                            ...
                            <button className="w-full h-12 px-4 py-2 mt-3 text-base font-bold text-white bg-blue-500 rounded-md hover:bg-blue-600">
                                {
                                    loading ? (
                                        <>
                                            <svg role="status" className="inline mr-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
