                ...
                <div className="self-center w-full mt-6">
                    <div className="bg-white border rounded-lg shadow-xl">
                        <form className="py-3 px-6" onSubmit={handleLogin}>
                            ...
                            <button className={`w-full h-12 px-20 py-2 mt-3 text-base font-bold ${loading ? 'opacity-50 cursor-not-allowed bg-blue-600' : ''}  text-white bg-blue-500 rounded-md hover:bg-blue-600`} {...(loading) ? { disabled: true } : {}} >{loading ? (
                                <>
