...
export default function Navbar() {
    return (
        <nav className="bg-white shadow-sm border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="hidden justify-between items-center w-full p-4 md:flex md:w-auto md:order-1" id="mobile-menu-3">
                    ...
                    <div className='flex md:justify-center justify-end items-center space-x-6 md:pl-6 md:mt-0 mt-6'>
