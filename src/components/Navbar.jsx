        ...
        <nav className="bg-white border-gray-200 md:shadow-transparent shadow-sm md:border-b md:px-0 px-4 py-4 rounded dark:bg-gray-800">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex items-center md:order-2 md:hidden">
                    ...
                    <button data-collapse-toggle="mobile-menu-3" type="button" className="inline-flex items-center p-2 ml-6 text-sm text-blue-500 rounded-lg md:hidden hover:bg-gray-100 active:bg-blue-500 active:text-white active:outline-none active:ring-2 active:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-3" aria-expanded="false">
